...
Ecrire-Rapport "Derniers incidents critiques" ( Select-String "CRITICAL" $LogFile | Select-Object -Last 3 | ForEach-Object { "Ligne $($_.LineNumber): $($_.Line.Split('—')[0])" } | Out-String ) $rapportPath
