...
Ecrire-Rapport "Compteurs" "INFO=$info  WARNING=$warning  ERROR=$erreur  CRITICAL=$critical" $rapportPath
...
Ecrire-Rapport "Derniers incidents critiques" $contenu $rapportPath
